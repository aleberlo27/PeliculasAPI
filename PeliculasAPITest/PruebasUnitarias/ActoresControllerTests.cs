...
namespace PeliculasAPITest.PruebasUnitarias
{
    ...
    public class ActoresControllerTests : BasePruebas
    {
        ...
        public async Task CrearActorSinFoto()
        {
            ...
            var actor = new ActorCreacionDTO() { Nombre = "Alejandra", FechaNacimiento = DateTime.Now };
        ...
        public async Task PatchActualizaUnSoloCampo()
        {
            ...
            patchDocument.Operations.Add(new Microsoft.AspNetCore.JsonPatch.Operations.Operation<ActorPatchDTO>("replace", "/nombre", null, "Claudia"));
            var respuesta = await controller.Patch(1, patchDocument);
            var resultado = respuesta as StatusCodeResult;
            Assert.AreEqual(204, resultado.StatusCode);

            var contexto3 = ConstruirContext(nombreBD);
            var actorDb = await contexto3.Actores.FirstOrDefaultAsync();
